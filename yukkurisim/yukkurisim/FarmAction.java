...
public class FarmAction extends ItemGeneratorActionBase {

	private static FarmAction myself;
	/******* インスタンスを得る(親インスタンスと引き換え) ********/
	public static synchronized FarmAction Get_Instance(yukkurisim_main own)
	{
		if( myself == null)
		{
			myself = new FarmAction(own);
		}

		return myself;
	}
	
	public FarmAction(yukkurisim_main own) {
		super(own);
	}
